...
#define PROGRAM_HELP \
	"usage: %s [-f[no-]builtin-loader] [-f[no-]runtime-rpath] [-f[no-]system-libraries] [-f[no-]static-runtime] [-fstl-version VERSION] [-f[no-]verbose]\n"\
	"\n"\
	...
	"  -fstl-version VERSION\n"\
	"                        Cross-compile code targeting a specific version of the GCC runtime libraries (integer in the range 4\u201316).\n"\
